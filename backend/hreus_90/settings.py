"""
Django settings for hreus_90 project.
...
WSGI_APPLICATION = 'hreus_90.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hreus_90 API",
    "DESCRIPTION": "API documentation for hreus_90 App",
    "VERSION": "v1",
}
